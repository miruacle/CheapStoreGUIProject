...
public class CusotmerLogIn extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CusotmerLogIn frame = new CusotmerLogIn();
